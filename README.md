...
API başlangıcında `EnsureCreated` çağrısı ile tablo yoksa oluşturur. Seed kategoriler: Sunucular, Veri Tabanları, İç Uygulamalar, Dış Uygulamalar, VPN Bilgileri.
